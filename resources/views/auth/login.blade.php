                ...
                <div class="card">
                    <div class="card-body px-lg-5 py-lg-5">
                        <div class="text-center text-muted mb-4">
                            <h5>
                                {{ __('Please enter your email and password to enter the system') }}
                            </h5>
                        </div>
                        <form role="form" method="POST" action="{{ route('login') }}">
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-success btn-block mt-3">{{ __('Login') }}</button>
                                <a href="{{route('register')}}" class="btn btn-primary btn-block mt-3">{{ __('Register') }}</a>
                            </div>
                        </form>
                    </div>
                </div>
